                ...
                <div class="card">
                    <div class="card-body">
                        <form action=""  method="get">
                            <center>
                                <img src="https://cdn-icons-png.flaticon.com/512/2897/2897785.png"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="00.01" min="1.00" class="form-control" id="exampleFormControlInput1"
                            ...
                            <div class="mb-3">
                                 <label for="exampleFormControlInput1" class="form-label">Fecha de fabricacion:</label>
                                <input type="date"  class="form-control" id="exampleFormControlInput1"
                                    placeholder="06/12/2026" name="txtff" required>
                            </div>
                            <div class="mb-3">
                                 <label for="exampleFormControlInput1" class="form-label">Fecha de vencimiento:</label>
                                <input type="date"  class="form-control" id="exampleFormControlInput1"
                                    placeholder="06/12/2026" name="txtfv" required>
                            </div>
                            <center>
                ...
                <table class="table table-dark table-hover" style="font-size: large;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>@mdo</td>
                            <td>
                                <i class="bi bi-person-dash-fill" style="font-size: 20px;"></i>
